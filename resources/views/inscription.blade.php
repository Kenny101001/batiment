        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">Rendez vos travaux plus rapide et plus facile !</p>
              @if ($errors->any())
              ...
              @endif
              <form id="formAuthentication" action="{{ route('ajoutUtilisateur') }}" method="post" class="mb-3">
              @csrf
                <div class="mb-3">
